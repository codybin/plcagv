 ...
 */
package com.xintai.redis.rediseventhanderl;
 ...
 */
public class RedisRequestHandler implements Lifecycle
    {
  ...
  @Inject
  public RedisRequestHandler(StatusEventDispatcher statusEventDispatcher,
 ...
 public  Object handleGetXintaiInfor(Request request, Response response)
      throws IllegalArgumentException, IllegalStateException {
    response.type(HttpConstants.CONTENT_TYPE_APPLICATION_JSON_UTF8);
  ...
  public  Object handleGetTransportOrders(Request request, Response response) {
    response.type(HttpConstants.CONTENT_TYPE_APPLICATION_JSON_UTF8);
    return toJson(
  ...
  public  Object handleGetTransportOrderByName(Request request, Response response) {
    response.type(HttpConstants.CONTENT_TYPE_APPLICATION_JSON_UTF8);
    return toJson(statusInformationProvider.getTransportOrderByName(request.params(":NAME")));
  }

  public  Object handleGetVehicles(Request request, Response response)
  ...
  public  Object handleGetVehicleByName(Request request, Response response)
      throws ObjectUnknownException {
    response.type(HttpConstants.CONTENT_TYPE_TEXT_PLAIN_UTF8);
    return toJson(statusInformationProvider.getVehicleStateByName(request.params(":NAME")));
  }

  public  Object handlePutVehicleIntegrationLevel(Request request, Response response)
