...
import com.xintai.kecongcontrol.ui.OrderCreateForm;
...
public interface AdapterPanelComponentsFactory {
 ...
 // ControlPanel createControlPanel(ExampleProcessModelTO processModel,
   ...
   * @return
   */
   KeCongControlForm createKeCongControlFormPanel(KeCongProcessModelTO processModel,
                                  VehicleService vehicleService);
   
   OrderCreateForm createOrderCreateFormFormPanel(KeCongProcessModelTO processModel,
                     KernelServicePortal kernelServicePortal,VehicleService vehicleService);
}
