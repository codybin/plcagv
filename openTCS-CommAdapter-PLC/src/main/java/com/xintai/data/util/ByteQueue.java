...
public class ByteQueue implements Cloneable {
 ...
 public int _popU2B() {
     ...
     */
    public int popU3B() {
        return ((pop() & 0xff) ) | ((pop() & 0xff) << 8) | ((pop() & 0xff)<< 16);
    }
     ...
     */
    public int popS4B() {
        return ((pop() & 0xff)) | ((pop() & 0xff) << 8) | ((pop() & 0xff) << 16) | ((pop()  & 0xff)<< 24);
    }
