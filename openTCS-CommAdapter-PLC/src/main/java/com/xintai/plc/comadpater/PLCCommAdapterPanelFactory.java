...
public class PLCCommAdapterPanelFactory
    implements VehicleCommAdapterPanelFactory {

  /**
   * This class's logger.
   */
  private static final Logger LOG = LoggerFactory.getLogger(PLCCommAdapterPanelFactory.class);
  /**
   * The service portal.
   */
   ...
   */
  @Inject
  public PLCCommAdapterPanelFactory(KernelServicePortal servicePortal,
...
//添加面板
  ...
  //向控制器添加界面的逻辑在此
    panels.add(componentsFactory.createPLCControlFormPanel((PLCProcessModelTO) processModel,
  ...
  private boolean providesPanelsFor(VehicleCommAdapterDescription description,
    ...
    return (description instanceof PLCCommAdapterDescription)
        && (processModel instanceof PLCProcessModelTO);
  }
}
