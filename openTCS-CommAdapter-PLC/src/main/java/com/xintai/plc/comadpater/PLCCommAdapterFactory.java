...
public class PLCCommAdapterFactory
    implements VehicleCommAdapterFactory {

  /**
   * This class's Logger.
   */
  private static final Logger LOG = LoggerFactory.getLogger(PLCCommAdapterFactory.class);
   ...
   */
  @Inject
  public PLCCommAdapterFactory(PLCAdapterComponentsFactory componentsFactory) {
  ...
  public VehicleCommAdapterDescription getDescription() {
    return new PLCCommAdapterDescription();
  }
