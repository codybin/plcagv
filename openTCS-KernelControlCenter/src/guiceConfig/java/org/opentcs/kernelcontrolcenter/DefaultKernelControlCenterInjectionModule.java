...
public class DefaultKernelControlCenterInjectionModule
  ...
  protected void configure() {
   ...
   install(new FactoryModuleBuilder().build(example.virtualvehicle.AdapterPanelComponentsFactory.class));
   //install(new FactoryModuleBuilder().build(com.xintai.vehicle.comadpter.AdapterPanelComponentsFactory.class));
    configureEventBus();
